...
namespace EdirneGeziAPI.Migrations
{
    ...
    [Migration("20260606162815_AddRouteSuggestionStops")]
    partial class AddRouteSuggestionStops
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EdirneGeziAPI.Models.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EdirneGeziAPI.Models.PlaceSuggestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EdirneGeziAPI.Models.RouteSuggestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EdirneGeziAPI.Models.RouteSuggestionStop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("RouteSuggestionId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("RouteSuggestionStops");
                });
            ...
            modelBuilder.Entity("EdirneGeziAPI.Models.Favorite", b =>
                {
                    b.HasOne("EdirneGeziAPI.Models.Place", "Place")
                        .WithMany()
                        .HasForeignKey("PlaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EdirneGeziAPI.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("EdirneGeziAPI.Models.RouteSuggestionStop", b =>
                {
                    b.HasOne("EdirneGeziAPI.Models.RouteSuggestion", "RouteSuggestion")
                        .WithMany("Stops")
                        .HasForeignKey("RouteSuggestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RouteSuggestion");
                });
